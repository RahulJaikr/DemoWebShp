...
public class AddProdcutToCart4 extends AbstractMethods {

	public WebDriver driver;

	public AddProdcutToCart4(WebDriver driver) {
		super(driver);
		this.driver = driver;
...
//	List<WebElement> selectHDD;
	...
	public void AddToCartBook(List<String> products) throws InterruptedException {
	...
	public void addApparelandShoes(List<String> products) throws InterruptedException {
	...
	public void addShoes(int index) {
		productAddTocart.get(index).click();
		// javaexecuotrPageLoad();
		invisibilityOfElement(spinner);
		javaexecuotrPageLoad();
